...
@section('title', 'Create Cognito User')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Create Cognito User</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Create New Cognito User</h5>
                </div>
                <div class="card-body">
                  @if(session('error'))
                  ...
                  <form action="{{ route('cognito_users.store') }}" method="POST">
                    @csrf
